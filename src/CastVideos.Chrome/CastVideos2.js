...
var CastPlayer = (function () {
    ...
    CastPlayer.prototype.initializeCastPlayer = function () {
        ...
        this.remotePlayerController.addEventListener(cast.framework.RemotePlayerEventType.IS_CONNECTED_CHANGED, this.switchPlayer.bind(this));
    };
    ;
    /*
    ...
    CastPlayer.prototype.setupLocalPlayer = function () {
        ...
        var playerTarget = {
            ...
            load: function (mediaIndex) {
                localPlayer.src =
                    _this.mediaContents[mediaIndex]['sources'][0];
                localPlayer.load();
            },
            getCurrentMediaTime: function () {
            ...
            setVolume: function (volumeSliderPosition) {
        ...
        var playerTarget = {
            play: function () {
                if (_this.remotePlayer.isPaused) {
                    _this.remotePlayerController.playOrPause();
                }
                var vi = document.getElementById('video_image');
            ...
            stop: function () {
                _this.remotePlayerController.stop();
            },
            load: function () { return function (mediaIndex) {
                console.log('Loading...' + _this.mediaContents[mediaIndex]['title']);
                var mediaInfo = new chrome.cast.media.MediaInfo(_this.mediaContents[mediaIndex]['sources'][0], 'video/mp4');
                mediaInfo.metadata = new chrome.cast.media.GenericMediaMetadata();
                mediaInfo.metadata.metadataType = chrome.cast.media.MetadataType.GENERIC;
                mediaInfo.metadata.title = _this.mediaContents[mediaIndex]['title'];
                mediaInfo.metadata.images = [
                    { 'url': MEDIA_SOURCE_ROOT + _this.mediaContents[mediaIndex]['thumb'] }];
                var request = new chrome.cast.media.LoadRequest(mediaInfo);
                castSession.loadMedia(request).then(_this.playerHandler.loaded.bind(_this.playerHandler), function (errorCode) {
            ...
            getCurrentMediaTime: function () {
                return _this.remotePlayer.currentTime;
            },
            getMediaDuration: function () {
                return _this.remotePlayer.duration;
            },
            updateDisplayMessage: function () {
                ...
                document.getElementById('playerstate').innerHTML =
                    _this.mediaContents[_this.currentMediaIndex]['title'] + ' ' +
                        _this.playerState + ' on ' + castSession.getCastDevice().friendlyName;
            },
            setVolume: function (volumeSliderPosition) {
                // Add resistance to avoid loud volume
                var currentVolume = _this.remotePlayer.volumeLevel;
                var p = document.getElementById('audio_bg_level');
                if (volumeSliderPosition < FULL_VOLUME_HEIGHT) {
                    var vScale = _this.currentVolume * FULL_VOLUME_HEIGHT;
                ...
                _this.remotePlayer.volumeLevel = currentVolume;
                _this.remotePlayerController.setVolumeLevel();
            },
            mute: function () {
                if (!_this.remotePlayer.isMuted) {
                    _this.remotePlayerController.muteOrUnmute();
                }
            },
            unMute: function () {
                if (_this.remotePlayer.isMuted) {
            ...
            isMuted: function () {
                return _this.remotePlayer.isMuted;
            },
            seekTo: function (time) {
                _this.remotePlayer.currentTime = time;
                _this.remotePlayerController.seek();
            }
        };
        this.playerHandler.setTarget(playerTarget);
    ...
    CastPlayer.prototype.seekMedia = function (event) {
        ...
        if (event.currentTarget.id == 'progress_indicator') {
            var curr = this.currentMediaTime + this.currentMediaDuration * pos /
                PROGRESS_BAR_WIDTH;
    ...
    CastPlayer.prototype.setVolume = function (mouseEvent) {
        ...
        if (mouseEvent.currentTarget.id === 'audio_bg_track') {
            ...
            pos = p.clientHeight - parseInt(mouseEvent.offsetY, 10);
        }
...
var PlayerHandler = (function () {
    ...
    PlayerHandler.prototype.updateDisplayMessage = function () {
