...
class CastPlayer {
    ...
    // #endregion Cast player variables

    // #region Current media variables
    ...
    // #endregion Current media variables
     ...
     */
    setupLocalPlayer() {
        var localPlayer = <HTMLVideoElement>document.getElementById('video_element');
    ...
    selectMedia(mediaIndex) {
        ...
        // Set video image
        var vi = <HTMLVideoElement>document.getElementById('video_image');
